...
%  m-file to reproduce Fig.S1(d) of the supplemental material
%--------------------------------------------------------------------

%%% First unzip the data file 
%%% Then load CC for cell #4
% c4=load('cell4.txt');

%%% Plot CC after smoothing
wsize=(1500);
for k=1:length(wsize)
smoothc4=smoothdata(c4(1:1200000,3),'movmean',wsize(k));
end
plot(smoothc4,c4(1:1200000,2),'color',[1 0.6 0.4]);hold on;
