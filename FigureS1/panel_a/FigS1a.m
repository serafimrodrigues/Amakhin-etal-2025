...
%  m-file to reproduce Fig.S1(a) and Fig.S5(b2) of the supplemental 
%  material 
%--------------------------------------------------------------------
...
smoothc1=smoothdata(c1(1:1200000,3),'movmean',wsize(k));
end
plot(smoothc1,c1(1:1200000,2),'color',[1 0.6 0.4]);
hold on;
...
%%% LAY-OUT for panel (b2) of Figure S5
% axis([190 210 -40 40]);
