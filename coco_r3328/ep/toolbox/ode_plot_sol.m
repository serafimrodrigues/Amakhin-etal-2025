...
%
%   ODE_PLOT_SOL([AH] [THEME], RUN, [LABS], [COL1, [IDX1], [COL2, [IDX2], [COL3, [IDX3]]]])
%
...
%
%   ODE_PLOT_SOL(AH, ...) uses the provided axis handle for plotting.

% Copyright (C) Frank Schilder, Harry Dankowicz
% $Id: ode_plot_sol.m 3234 2023-05-29 03:08:12Z hdankowicz $

thm = struct();

grammar   = '[AH] [THM] RUN [LABS] [C1 [I1] [C2 [I2] [C3 [I3]]]]';
args_spec = {
   'AH',     '', 'axes',     'ah',    gca, 'read', {}
...
thm.plot_sol(ah, thm, args, tb_info, dim, bd, HH);
