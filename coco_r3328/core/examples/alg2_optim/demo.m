...
prob  = coco_add_pars(prob,'x', 'x', chart.x, chart.t);
chart = coco_read_solution('y', 'run1', lab, 'chart');
prob  = coco_add_pars(prob,'y', 'y', chart.x, chart.t);
prob  = coco_add_func(prob, 'bound', @bound, @bound_du, [], ...
  'inequality', 'bound', 'uidx', 2);
prob  = coco_add_func(prob, 'obj', @obj, @obj_du, [], ...
  'inactive', 'obj', 'uidx', [1 2]);
% adjoint
chart = coco_read_adjoint('x', 'run1', lab, 'chart');
prob  = coco_add_adjt(prob, 'x', 'd.x', 'l0', chart.x, 'tl0', chart.t);
chart = coco_read_adjoint('y', 'run1', lab, 'chart');
prob  = coco_add_adjt(prob, 'y', 'd.y', 'l0', chart.x, 'tl0', chart.t);
chart = coco_read_adjoint('bound', 'run1', lab, 'chart');
prob  = coco_add_adjt(prob, 'bound', 'ncp.bound', 'aidx', 2, ...
