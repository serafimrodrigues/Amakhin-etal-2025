...
% zero problem
chart = coco_read_solution('cusp', 'cusp1', BPlab(1), 'chart');

prob2 = coco_add_func(prob, 'cusp', @cusp, @cusp_du, @cusp_dudu, [], ...
  'zero', 'u0', chart.x, 't0', chart.t);
prob2 = coco_add_pars(prob2, 'pars', [2; 3], {'u2', 'u3'}, 'inactive');

% adjoints
chart = coco_read_adjoint('cusp', 'cusp1', BPlab(1), 'chart');
prob2 = coco_add_adjt(prob2, 'cusp', 'l0', chart.x, 'tl0', chart.t);
chart = coco_read_adjoint('pars', 'cusp1', BPlab(1), 'chart');
