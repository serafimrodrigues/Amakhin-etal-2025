...
subplot(2,2,1)
hold on
ode_plot_bd(struct('axlabs', false), '22', 'D', '||x||')
hold off
axis([0.15 0.4 1 7])
grid on
drawnow
...
subplot(2,2,1)
hold on
ode_plot_bd(struct('axlabs', false), '23', 'D', '||x||')
hold off
axis([0.15 0.4 1 7])
grid on
drawnow
...
subplot(2,2,2)
hold on
ode_plot_bd(struct('axlabs', false), '32', 'D', '||x||')
hold off
axis([0.15 0.4 1 7])
grid on
drawnow
...
subplot(2,2,2)
hold on
ode_plot_bd(struct('axlabs', false), '33', 'D', '||x||')
hold off
axis([0.15 0.4 1 7])
grid on
drawnow
...
subplot(2,2,3)
hold on
ode_plot_bd(struct('axlabs', false), '42', 'D', '||x||')
hold off
axis([0.15 0.4 1 7])
grid on
drawnow
...
subplot(2,2,3)
hold on
ode_plot_bd(struct('axlabs', false), '43', 'D', '||x||')
hold off
axis([0.15 0.4 1 7])
grid on
drawnow
...
subplot(2,2,4)
hold on
ode_plot_bd(struct('axlabs', false), '52', 'D', '||x||')
hold off
axis([0.15 0.4 1 7])
grid on
drawnow
...
subplot(2,2,4)
hold on
ode_plot_bd(struct('axlabs', false), '53', 'D', '||x||')
hold off
axis([0.15 0.4 1 7])
grid on
drawnow
