...
subplot(2,2,1)
ode_plot_bd(struct('ylab', 'MAX(X_3)'), '21', 'D', 'MAX(x)', 3)
axis([0.15 0.4 1 10])
grid on
drawnow
...
subplot(2,2,1)
hold on
ode_plot_bd(struct('axlabs', false), '22', 'D', 'MAX(x)', 3)
hold off
axis([0.15 0.4 1 10])
grid on
drawnow
...
subplot(2,2,1)
hold on
ode_plot_bd(struct('axlabs', false), '23', 'D', 'MAX(x)', 3)
hold off
axis([0.15 0.4 1 10])
grid on
drawnow
...
subplot(2,2,2)
ode_plot_bd(struct('ylab', 'MAX(X_3)'), '31', 'D', 'MAX(x)', 3)
axis([0.15 0.4 1 10])
grid on
drawnow
...
subplot(2,2,2)
hold on
ode_plot_bd(struct('axlabs', false), '32', 'D', 'MAX(x)', 3)
hold off
axis([0.15 0.4 1 10])
grid on
drawnow
...
subplot(2,2,2)
hold on
ode_plot_bd(struct('axlabs', false), '33', 'D', 'MAX(x)', 3)
hold off
axis([0.15 0.4 1 10])
grid on
drawnow
...
subplot(2,2,3)
ode_plot_bd(struct('ylab', 'MAX(X_3)'), '41', 'D', 'MAX(x)', 3)
axis([0.15 0.4 1 10])
grid on
drawnow
...
subplot(2,2,3)
hold on
ode_plot_bd(struct('axlabs', false), '42', 'D', 'MAX(x)', 3)
hold off
axis([0.15 0.4 1 10])
grid on
drawnow
...
subplot(2,2,3)
hold on
ode_plot_bd(struct('axlabs', false), '43', 'D', 'MAX(x)', 3)
hold off
axis([0.15 0.4 1 10])
grid on
drawnow
...
subplot(2,2,4)
ode_plot_bd(struct('ylab', 'MAX(X_3)'), '51', 'D', 'MAX(x)', 3)
axis([0.15 0.4 1 10])
grid on
drawnow
...
subplot(2,2,4)
hold on
ode_plot_bd(struct('axlabs', false), '52', 'D', 'MAX(x)', 3)
hold off
axis([0.15 0.4 1 10])
grid on
drawnow
...
subplot(2,2,4)
hold on
ode_plot_bd(struct('axlabs', false), '53', 'D', 'MAX(x)', 3)
hold off
axis([0.15 0.4 1 10])
grid on
drawnow
