...
% $Id: coco_add_pars.m 3324 2025-01-17 21:40:20Z hdankowicz $
...
assert(~strcmpi(par_type, 'zero'), ...
  '%s: parameter type must be one of active, inactive, internal, regular, discrete, or singular', ...
  mfilename);
...
assert(~any(strcmpi(par_type, {'zero' 'regular' 'discrete' 'singular'})), ...
