...
%   J        = COCO_EZDFDX(KEY, ...)
%
%   The routines COCO_NUM_DFDX, COCO_NUM_DFDXV, COCO_NUM_DFDP, and
%   COCO_NUM_DFDPV use mid-point finite-difference scheme for numerically
%   approximating the Jacobian of the right-hand side with respect to the
%   state vector at a number of distinct points and with respect to the
%   parameter vector at a number of distinct points. Each function includes
%   the possibility of differentiation of an algorithm rather than a
