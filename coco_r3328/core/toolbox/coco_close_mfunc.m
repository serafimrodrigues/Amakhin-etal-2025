...
% $Id: coco_close_mfunc.m 3324 2025-01-17 21:40:20Z hdankowicz $
...
bdp_idx = [efunc.inactive_pars efunc.active_pars efunc.internal_pars ...
  efunc.inequality_pars efunc.regular_pars efunc.discrete_pars ...
  efunc.singular_pars];
...
pararrays = { 'regular_pars' 'discrete_pars' 'singular_pars' };
...
pararrays = { 'primary_pars' 'active_pars' 'inactive_pars' ...
  'internal_pars' 'inequality_pars' 'regular_pars' 'discrete_pars' ...
  'singular_pars' };
partypes  = { 'continuation' 'continuation' 'continuation'  ...
	'continuation' 'continuation' 'regular' 'discrete' 'singular' };
