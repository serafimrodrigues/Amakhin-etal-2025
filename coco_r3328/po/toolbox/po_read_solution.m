...
% $Id: po_read_solution.m 3320 2025-01-11 16:13:25Z hdankowicz $
...
switch branch_type
  ...
  case 'po.SN'
    ...
    sol.sn.u  = chart.x(data.po_sn.b_idx);
    sol.sn.t  = chart.t(data.po_sn.b_idx);
    sol.sn.u0 = sol.sn.u;
    sol.sn.t0 = sol.sn.t;
  ...
  case 'po.TR'
    ...
    sol.tr.u  = chart.x([data.po_tr.a_idx; data.po_tr.b_idx]); %[a; b];
    sol.tr.t  = chart.t([data.po_tr.a_idx; data.po_tr.b_idx]);
    sol.tr.u0 = sol.tr.u;
    sol.tr.t0 = sol.tr.t;
