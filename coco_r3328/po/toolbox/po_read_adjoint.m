...
switch format
  ...
  case 'po.v2'
    ...
    [data, chart1] = coco_read_adjoint(tbid, run, lab, 'data', ...
      'chart');
    ...
    chart2 = coco_read_adjoint(pfid, run, lab, 'chart');
    sol.T_l   = chart2.x;
    sol.T_tl  = chart2.t;
    sol.T_l0  = chart2.x;
    sol.T_tl0 = chart2.t;
    ...
    if ~data.ode.autonomous
      ...
      chart3 = coco_read_adjoint(sfid, run, lab, 'chart');
      sol.tinit_l   = chart3.x;
      sol.tinit_tl  = chart3.t;
      sol.tinit_l0  = chart3.x;
      sol.tinit_tl0 = chart3.t;
    else
      sol.tinit_l0  = [];
      sol.tinit_tl0 = [];
    end    
