...
%   \end{array}\right]
% $$
%% Load xpackage (if octave is used)
...
[derivs,fstr]=sco_sym2funcs(f,...   % symbolic expression for f
    ...
    'multifile',true,...            % create one file per function
    'folder','private',...          % store files in local folder private
    'output',{'derivatives','funcstr'}); % output symbolic derivatives 
