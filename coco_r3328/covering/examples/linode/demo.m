...
%% Continue one-dimensional family of periodic orbits with atlas_1d with default norm
prob = coco_set(prob, 'cont', 'atlas', '1d', 'PtMX', 200,  ...
  'NAdapt', 1, 'h0', .05, 'h_max', .05, 'h_min', .05);
coco(prob, 'dim_1_atlas_1d', [], 1, 'p1', [0.2 2]);

%% Continue one-dimensional family of periodic orbits with atlas_1d with maximum norm
prob = coco_set(prob, 'cont', 'atlas', '1d', 'PtMX', 200,  ...
  'NAdapt', 1, 'h0', .05, 'h_max', .05, 'h_min', .05, 'norm', inf);
coco(prob, 'dim_1_atlas_1d', [], 1, 'p1', [0.2 2]);
