...
% zero problems
prob2 = ode_bvp2bvp(prob, 'orb1', 'linode1', BPlab(1));
prob2 = ode_bvp2bvp(prob2, 'orb2', 'linode1', BPlab(1));
...
% adjoints
prob2 = adjt_bvp2bvp(prob2, 'orb1', 'linode1', BPlab(1));
prob2 = adjt_bvp2bvp(prob2, 'orb2', 'linode1', BPlab(1));
...
chart = coco_read_adjoint('glue', 'linode1', BPlab(1), 'chart');
prob2 = coco_add_adjt(prob2, 'glue', 'aidx', ...
  [axidx1(opt1.p_idx); axidx2(opt2.p_idx)], ...
  'l0', chart.x, 'tl0', chart.t);
chart = coco_read_adjoint('amp', 'linode1', BPlab(1), 'chart');
